...
Source: https://platform.openai.com/docs/api-reference/vector-stores-file-batches/listBatchFiles
...
## Returns
A list of [vector store file](../vector-stores-files/file-object.md) objects.
