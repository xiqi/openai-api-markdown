...
Source: https://platform.openai.com/docs/api-reference/certificates/activateOrganizationCertificates
...
## Returns
A list of [Certificate](object.md) objects that were activated.
