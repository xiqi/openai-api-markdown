...
Source: https://platform.openai.com/docs/api-reference/messages/getMessage
...
## Parameters
- `thread_id` (path, string, required): The ID of the [thread](../threads/index.md) to which this message belongs.
...
## Returns
The [message](object.md) object matching the specified ID.
