...
Source: https://platform.openai.com/docs/api-reference/messages/createMessage
...
## Parameters
- `thread_id` (path, string, required): The ID of the [thread](../threads/index.md) to create a message for.
