...
Source: https://platform.openai.com/docs/api-reference/usage/vector_stores
...
## Returns
A list of paginated, time bucketed [Vector stores usage](vector_stores_object.md) objects.
