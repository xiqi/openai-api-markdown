...
Source: https://platform.openai.com/docs/api-reference/role-assignments/organization/groups/list
...
## Parameters
- `group_id` (path, string, required): The ID of the group whose organization role assignments you want to list.
