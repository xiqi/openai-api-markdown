...
Source: https://platform.openai.com/docs/api-reference/responses-streaming/response/output_item/added

Emitted when a new output item is added.

## Properties
- `type` (string, required): The type of the event. Always `response.output_item.added`. Enum: 'response.output_item.added'.
