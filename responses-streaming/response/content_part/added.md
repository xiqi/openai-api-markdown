...
Source: https://platform.openai.com/docs/api-reference/responses-streaming/response/content_part/added

Emitted when a new content part is added.

## Properties
- `type` (string, required): The type of the event. Always `response.content_part.added`. Enum: 'response.content_part.added'.
