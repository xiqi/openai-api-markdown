...
Source: https://platform.openai.com/docs/api-reference/responses-streaming/response/queued

Emitted when a response is queued and waiting to be processed.

## Properties
- `type` (string, required): The type of the event. Always 'response.queued'. Enum: 'response.queued'.
