...
- `tool_resources` (object | null, optional)
  - Variant (object):
    ...
    - `file_search` (object, optional)
      - `vector_store_ids` (array<string>, optional): The [vector store](../vector-stores/object.md) attached to this assistant. There can be a maximum of 1 vector store attached to the assistant.
      - `vector_stores` (array<object>, optional): A helper to create a [vector store](../vector-stores/object.md) with file_ids and attach it to this assistant. There can be a maximum of 1 vector store attached to the assistant.
        - Items:
          - ...
