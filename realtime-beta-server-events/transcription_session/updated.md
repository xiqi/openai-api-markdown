...
Source: https://platform.openai.com/docs/api-reference/realtime-beta-server-events/transcription_session/updated
...
- `type` (string, required): The event type, must be `transcription_session.updated`. Enum: 'transcription_session.updated'.
