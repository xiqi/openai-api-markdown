...
Source: https://platform.openai.com/docs/api-reference/realtime-beta-server-events/response/done
...
- `type` (string, required): The event type, must be `response.done`. Enum: 'response.done'.
